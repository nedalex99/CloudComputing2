...
set GRPC_PATH=D:\Facultate\An2\CNA\vcpkg-master\installed\x86-windows\tools\grpc
set PROTOC_PATH=D:\Facultate\An2\CNA\vcpkg-master\installed\x86-windows\tools\protobuf
